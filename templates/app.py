...
def convert():
    ...
    if stbase == endbase:
         instructions = "No conversion necessary, number will not change"
    for x in range(0,15):
           #test = ((number % 10**()))
    ...
    return render_template('index.html', result=result, conversion=conversion, instructions=instructions)
